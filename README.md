...
- **liff-development**: Build, debug, or implement LINE Front-end Framework (LIFF) applications based on official API reference.
...
└── skills/               # Skills directory
    ...
    │   └── SKILL.md
    └── liff-development/ # LIFF development skill
        └── SKILL.md
```
